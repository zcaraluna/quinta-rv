        ...
        <>
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="rounded-2xl border-none shadow-2xl p-2 min-w-[180px]">
                    <DropdownMenuLabel className="font-black uppercase tracking-widest text-[9px] text-muted-foreground px-3 py-2">Gestión de Reserva</DropdownMenuLabel>

                    <DropdownMenuItem
                        onClick={() => setReassignOpen(true)}
                        className="rounded-xl gap-2 font-bold cursor-pointer text-primary focus:text-primary focus:bg-primary/5"
                    >
                        <ArrowRightLeft size={16} /> Reasignar / Mover
                    </DropdownMenuItem>
