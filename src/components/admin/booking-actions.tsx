        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="rounded-2xl border-none shadow-2xl p-2 min-w-[180px]">
                ...
                {currentStatus !== 'CONFIRMED' && (
                    <DropdownMenuItem onClick={() => handleUpdate('CONFIRMED')} className="rounded-xl gap-2 font-bold cursor-pointer text-emerald-600 focus:text-emerald-600 focus:bg-emerald-50">
